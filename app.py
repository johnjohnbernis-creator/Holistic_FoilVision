...
def create_snapshot(img: Image.Image, roi, color_hex: str, label: str) -> Image.Image:
    ...
    bordered = Image.new("RGB", (crop.width + 8, crop.height + 40), "#111")
    bordered.paste(crop, (4, 36))
...
if not st.session_state.images:
    st.info("Load an image folder to begin.")
    st.stop()
